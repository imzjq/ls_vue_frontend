<template>
  <div class="app-container">
    <div class="filter-container">
      <condition-template :data="moreOptions" :isShow="isShow" :defaultDate="defaultDate" :listQuery="listQuery"  v-on:search="search"/>
...
<script>
  ...
  import {moreOptions,generalListQuery,generalOptions} from './data/hit';
  ...
  export default {
    ...
    methods:{
      ...
      getData(){
        ...
        curd('getHit',this.listQuery).then(response => {
          ...
          this.lineChartData.text = response.data.totalHit
          this.listQuery.time = response.data.date
          this.count++
