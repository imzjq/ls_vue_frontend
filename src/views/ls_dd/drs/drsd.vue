      ...
      <template slot="append">
        <el-table-column label="操作" >
          <template slot-scope="scope">
            ...
            <el-button   size="mini" type="success"  @click="handleDrs(scope.row)">解析</el-button>
          </template>
        </el-table-column>
      </template>
    </TableList>
    ...
    <el-dialog :close-on-press-escape="false" :close-on-click-modal="false" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm"  :model="temp" label-position="left" label-width="90px" style='width: 400px; margin-left:50px;'>
        ...
        <el-form-item label="域名">
          <el-input v-model="temp.dname"></el-input>
        </el-form-item>
        ...
        <!--<el-form-item label="是否高防">-->
          <!--<el-radio-group v-model="temp.high_anti" size="small">-->
            <!--<el-radio :label=1 border>高防</el-radio>-->
            <!--<el-radio :label=0 border >普通</el-radio>-->
          <!--</el-radio-group>-->
        <!--</el-form-item>-->
        <el-form-item label="是否备案">
          <el-radio-group v-model="temp.icp" size="small">
            <el-radio :label=1 border>已备案</el-radio>
            <el-radio :label=0 border >未备案</el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item label="备案号">
          <el-input v-model="temp.icpcode"></el-input>
        </el-form-item>
        <!--<el-form-item label="白名单开关">-->
          <!--<el-radio-group v-model="temp.white_switch" size="small">-->
...
<script>
  ...
  import {moreOptions,generalListQuery,generalOptions,getTableFields,getTemp} from './data/drsd';
  ...
  export default {
    ...
    methods:{
      ...
      handleDrs(row){
        this.$router.push({ name: 'drs_drs', params: { did: row.id }})
      },
    }
  }
</script>
