  ...
  <div class="app-container">
    <el-form ref="form" :model="listQuery"  label-width="80px">
      ...
      <div class="filter-container" v-if="update">
        ...
        <el-checkbox-group v-model="listQuery.checkedDomain" >
          <el-row >
            <el-col :span="5" v-for="(item,index) in domainData" :key="index">
...
<script>
  ...
  import {brandOptions,packageOptions,domainRemapOptions} from '@/api/public'
  ...
  export default {
    ...
    methods: {
      getList()
      {
        domainRemapOptions(this.listQuery).then(response => {
          this.listQuery.checkedDomain = []
          this.domainData = response.data
          this.update = true
        })
      },
      onSubmit() {
        if(this.listQuery.checkedDomain.length > 0){
